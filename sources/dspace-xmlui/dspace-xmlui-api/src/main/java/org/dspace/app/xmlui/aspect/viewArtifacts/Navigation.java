...
public class Navigation extends AbstractDSpaceTransformer implements CacheableProcessingComponent {
            ...
            AuthorizeException
    {
        ...
        // add oai
        String oaiUrlKey = ConfigurationManager.getProperty("lr", "lr.dspace.oai.url");
        if (oaiUrlKey != null && oaiUrlKey.length() > 0)
        {
            pageMeta.addMetadata("request","OAIURL").addContent(oaiUrlKey);
        }
