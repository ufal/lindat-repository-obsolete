...
public class UFALExtraMetadataStep extends DescribeStep
{
        ...
        UIException, SQLException, IOException, AuthorizeException
        {
                ...
                for (int i = 0; i < inputs.length; ++i )
                {
                    ...
                    DCValue[] dcValues = item.getMetadata(
     ...
     * @throws SAXException 
     */
    private DCValue[] mapped_values( Item item, DCInput dcInput, DCValue[] dcValues ) throws SAXException
    {
     ...
     */
    private void render( 
        List form, Item item, DCInput dcInput, DCValue[] dcValues, DCInputSet inputSet, Collection collection, String scope ) 
                        throws WingException
    {
