	                    ...
	                    jQuery(".licenseselector").licenseSelector(
	                            {
	                                    onLicenseSelected: function (license) {
	                                            ...
	                                            var allLic = jQuery("#aspect_submission_StepTransformer_list_bulleted-list li a");
	                                            for(var i=0;i<allLic.length;i++) {
	                                                    if(allLic[i].href==selectedLic) {
	                                                    		var id = allLic[i].name.replace("_", "");
	                                                    		jQuery("#aspect_submission_StepTransformer_field_license").val(id);
	                                                            break;
	                                                    }
	                                            }
	                            }
...
ufal.utils = {
	...
	convert_language_iso_codes : function() {
		var isoFieldsSelectors = '.language-iso-code, ' +
			...
			'#aspect_discovery_SidebarFacetsTransformer_list_language [href*="language_filter"] span.wordbreak, ' +
